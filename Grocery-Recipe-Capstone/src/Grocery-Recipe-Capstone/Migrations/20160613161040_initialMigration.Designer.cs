...
namespace GroceryRecipeCapstone.Migrations
{
    ...
    [Migration("20160613161040_initialMigration")]
            ...
            modelBuilder.Entity("Grocery_Recipe_Capstone.Models.FavoritedRecipe", b =>
                {
                    ...
                    b.Property<int?>("FavoritedRecipesFavoritedRecipeId");
                    ...
                    b.HasIndex("FavoritedRecipesFavoritedRecipeId");
            ...
            modelBuilder.Entity("Grocery_Recipe_Capstone.Models.FavoritedRecipe", b =>
                {
                    b.HasOne("Grocery_Recipe_Capstone.Models.FavoritedRecipe")
                        .WithMany()
                        .HasForeignKey("FavoritedRecipesFavoritedRecipeId");
